          ...
          <!-- tab start-->
           <div class="card">
            ...
            <div class="tabs">
                      ...
                      <table class="table table-borderless table-responsive">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <?php $__currentLoopData = $query; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <td width="10%"><?php echo e(isset($data->UIDNO)?$data->UIDNO:'Not Available'); ?> </td>
                              <td width="20%"><?php echo e($data->HUTOWNERNAME); ?></td>
                              <td width="10%">Not Available</td>
                              <td width="30%"><?php echo e($data->Address); ?></td>
                              <!-- <td width="10%">Not Available</td> -->
                              <!-- <td width="10%">Not Available</td> -->
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  ...
                  <div class="card-body">
                    <div class="table-responsive" id="sra-table">
                      <table class="table table-borderless table-responsive">
                        ...
                        <tbody>
                          <tr>
                            <td width="10%"><?php echo e(isset($documents[0]->uid)?$documents[0]->uid:'Not Available'); ?></td>
                            <td width="20%"><?php echo e(isset($documents[0]->name)?$documents[0]->name:'Not Available'); ?></td>
                            <td width="10%">
                            <?php 
                            ...
                            <td width="30%"><?php echo e(isset($documents[0]->address)?$documents[0]->address:'Not Available'); ?></td>
                            <!-- <td width="10%"><?php echo e(isset($documents[0]->purchaser_name  )?$documents[0]->purchaser_name :'Not Available'); ?></td>
                            <td width="10%"><?php echo e(isset($documents[0]->relationship)?$documents[0]->relationship:'Not Available'); ?></td> -->
                      ...
                      <!-- ocr image start-->
                       <div class="card">
                          <div class="card-body">
                            ...
                            <!-- <img src="http://sra-uat.apniamc.in/images/<?php echo e($img[0]); ?>" style="height:320px;width:250px;" id="myImg"> -->
                            <?php }else{ ?>
                                    ...
                                    <div class="table-responsive" id="sra-table">
                                      <table class="table table-borderless table-responsive">
                                        ...
                                        <tbody>
                                          ...
                                          <?php }else {?>
                                          <form method="POST" enctype="multipart/form-data" action="<?php echo e(route('admin.sra.storemanualdata_adhar')); ?>">
                                          <?php echo csrf_field(); ?>
                  ...
                  <div class="card-body">
                    <div class="table-responsive" id="sra-table">
                        <table class="table table-borderless table-responsive">
                            <thead>
                                <tr>
                                    <th width="10%" style="background-color:<?= $color_uid; ?>; color: #fff !important;padding: 5px !important;">UID No (<?php echo e(round($highestPercentageOfUID)); ?>%)</th>
                                    <th width="20%" style="background-color:<?= $color_name; ?>; color: #fff !important;padding: 5px !important;">Owner Name (<?php echo e(round($highestPercentageOfName1)); ?>%)</th>
                                    <th width="20%" style="background-color:<?= $color_date; ?>; color: #fff !important;padding: 5px !important;">Dob (<?php echo e(round($highestPercentageOfdate)); ?>%)</th>
                                    <th width="30%" style="background-color:<?= $color_address; ?>; color: #fff !important;padding: 5px !important;">Address (<?php echo e(round($highestPercentageOfAddress1)); ?>%)</th>
                                   
                                  </tr>
                                  <tr>
                                <td width="10%"><?php echo e(isset($highestPercentageUID )?$highestPercentageUID:'Not Available'); ?></td>
                                 <td width="10%"><?php echo e(isset($highestPercentageName1)?$highestPercentageName1:'Not Available'); ?></td>
                                <td width="20%"><?php echo e(isset($highestPercentagedate)?$highestPercentagedate:'Not Available'); ?></td>
                                <td width="30%"><?php echo e(isset($highestPercentageAddress1)?$highestPercentageAddress1:'Not Available'); ?></td>
                               
                              </tr>
                              <form method="post" enctype="multipart/form-data" action="<?php echo e(route('admin.sra.storeremark_adhar')); ?>">
                              <?php echo csrf_field(); ?>
                              <input type="hidden" name="hutid" value="<?php echo $hid;?>">
                              <input type="hidden" name="year" value="<?php echo e($year_val); ?>">
                              ...
                              <tr>
                                 ...
                                 if(isset($highestPercentageOfUID) && $highestPercentageOfUID == 100)
                                 {
                                  ...
                                  ?>
                                    <select name="elg1" class="form-control" style="padding: 2px 1rem !important;">
                                        ...
                                        <option value="1" <?php echo e(isset($highestPercentageOfUID) && $highestPercentageOfUID < 100 ? 'selected' : ''); ?>>Manual</option>
                                        <option value="2" <?php echo e(isset($highestPercentageOfUID) && $highestPercentageOfUID == 100 ? 'selected' : ''); ?>>Auto</option>
                                    </select>
                                  <?php
                                 }
                                ?>
                                ...
                                <?php
                                 ...
                                 {
                                  ?>
                                    <input type="text" class="form-control" name="elg" value="Auto" readyonly>
                                  <?php
                                 }else{
                                  ?> 
                   ...
                              </tr>
                              ...
                              <tr>
                                <?php if (count($query_data) > 0) {  ?>
                                <td width="10%"><?php echo e(isset($query_data[0]->remark_uid)?$query_data[0]->remark_uid:''); ?></td>
                                <td width="10%"><?php echo e(isset($query_data[0]->remark_name)?$query_data[0]->remark_name:''); ?></td>
                                <td width="20%"><?php echo e(isset($query_data[0]->remark_dob)?$query_data[0]->remark_dob:''); ?></td>
                                <td width="20%"><?php echo e(isset($query_data[0]->remark_address)?$query_data[0]->remark_address:''); ?></td>
                              
                                <?php }else { ?>

                                <td width="10%"><input type="text" class="form-control"  name="remark1" value="<?php echo e(isset($query_data[0]->remark_uid)?$query_data[0]->remark_uid:''); ?>" ></td>
                                <td width="10%"><input type="text" class="form-control"  name="remark2" value="<?php echo e(isset($query_data[0]->remark_name)?$query_data[0]->remark_name:''); ?>" ></td>
                                <td width="20%"><input type="text" class="form-control"  name="remark3" value="<?php echo e(isset($query_data[0]->remark_dob)?$query_data[0]->remark_dob:''); ?>" ></td>
                                <td width="20%"><input type="text" class="form-control"  name="remark4" value="<?php echo e(isset($query_data[0]->remark_address)?$query_data[0]->remark_address:''); ?>" ></td>
                          ...
                          <tr>
                             <td width="10%">
                              ...
                              <td width="10%" colspan="5">
                                ...
                                <?php } else  { ?>
                                <textarea class="form-control" style="height:auto!important;"  name="remark" <?php echo e(isset($query_data[0]->overall_remark) ? 'readonly' : ''); ?> cols="100"><?php echo e(isset($query_data[0]->overall_remark) ? $query_data[0]->overall_remark : $remark); ?></textarea>
                              <?php } ?>
                              </td>
                        </tr>
                              <tr>
                ...
                <div class="card">
                  <div class="card-body">
                    <div class="table-responsive" id="sra-table">
                        <table class="table table-borderless table-responsive">
                            ...
                            <tr>
                                ...
                                <td width="10%"><?php echo e(isset($highestPercentageUID)?$highestPercentageUID:'Not Available'); ?></td>
                                 <td width="10%"><?php echo e(isset($highestPercentageName1)?$highestPercentageName1:'Not Available'); ?></td>
                                <td width="10%"><?php echo e(isset($highestPercentagedate)?$highestPercentagedate:'Not Available'); ?></td>
                                <td width="20%"><?php echo e(isset($highestPercentageAddress1)?$highestPercentageAddress1:'Not Available'); ?></td>
                              ...
                              <tr>
                                ...
                                <select name="elg3" class="form-control" style="padding: 2px 1rem !important;">
                                    <option value="0">-- Select Option --</option>
                                    <option value="1" <?php echo e(isset($highestPercentageOfdate) && $highestPercentageOfdate < 100 ? 'selected' : ''); ?>>Manual</option>
                                    <option value="2" <?php echo e(isset($highestPercentageOfdatehighestPercentageOfdate) && $highestPercentageOfdate == 100 ? 'selected' : ''); ?>>Auto</option>
                                </select>
                                </td>
                                <td width="10%">
                                <select name="elg4" class="form-control" style="padding: 2px 1rem !important;">
                   ...
                              </tr>
                              ...
                              <tr>
                                 <?php if (count($recomm_remarks_ca) > 0) { ?>
                                <td width="10%"><?php echo e(isset($recomm_remarks_ca[0]->remark_uid)?$recomm_remarks_ca[0]->remark_uid:''); ?></td>
                                <td width="10%"><?php echo e(isset($recomm_remarks_ca[0]->remark_name)?$recomm_remarks_ca[0]->remark_name:''); ?></td>
                                <td width="20%"><?php echo e(isset($recomm_remarks_ca[0]->remark_dob)?$recomm_remarks_ca[0]->remark_dob:''); ?></td>
                                <td width="20%"><?php echo e(isset($recomm_remarks_ca[0]->remark_address)?$recomm_remarks_ca[0]->remark_address:''); ?></td>
                                
                                <?php }else { ?>
                                <td width="10%"><input type="text" class="form-control"  name="remark1_ca" value="<?php echo e(isset($recomm_remarks_ca[0]->remark_uid)?$recomm_remarks_ca[0]->remark_uid:''); ?>" ></td>
                                <td width="10%"><input type="text" class="form-control"  name="remark2_ca" value="<?php echo e(isset($recomm_remarks_ca[0]->remark_name)?$recomm_remarks_ca[0]->remark_name:''); ?>" ></td>
                                <td width="20%"><input type="text" class="form-control"  name="remark3_ca" value="<?php echo e(isset($recomm_remarks_ca[0]->remark_dob)?$recomm_remarks_ca[0]->remark_dob:''); ?>" ></td>
                                <td width="20%"><input type="text" class="form-control"  name="remark4_ca" value="<?php echo e(isset($recomm_remarks_ca[0]->remark_address)?$recomm_remarks_ca[0]->remark_address:''); ?>" ></td>
                          ...
                          <tr>
                             <td width="10%">
                              ...
                              <?php } else { ?>
                                ...
                                <select name="elg" class="form-control" style="padding: 2px 1rem !important;">
                                  <option value="0">-- Select Option --</option>
                                  <option value="1" <?php echo e(isset($recomm_remarks_ca[0]->overall_eligibility) && ($recomm_remarks_ca[0]->overall_eligibility == 1) ? 'selected' : ''); ?>>Verified</option>
                                  <option value="2" <?php echo e(isset($recomm_remarks_ca[0]->overall_eligibility) && ($recomm_remarks_ca[0]->overall_eligibility == 2) ? 'selected' : ''); ?>>Not Matched</option>
                                  <option value="3" <?php echo e(isset($recomm_remarks_ca[0]->overall_eligibility) && ($recomm_remarks_ca[0]->overall_eligibility == 3) ? 'selected' : ''); ?>>Unavailable</option>
                                </select>
                              <?php } ?>
                              </td> 
                              <td width="10%" colspan="5">
                                <?php if (count($recomm_remarks_ca) > 0) { ?>
                                  <?php echo e(isset($recomm_remarks_ca[0]->overall_remark) ? $recomm_remarks_ca[0]->overall_remark : 'Not Available'); ?>

                                <?php } else  { ?>
                                <textarea class="form-control" style="height:auto!important;"  name="remark" <?php echo e(isset($recomm_remarks_ca[0]->overall_remark) ? 'readonly' : ''); ?> cols="100"><?php echo e(isset($recomm_remarks_ca[0]->overall_remark) ? $recomm_remarks_ca[0]->overall_remark : $remark); ?></textarea>
                              <?php } ?>
                               </td>
                        </tr>
                              <tr>
                                  ...
                                  <table class="table table-borderless table-responsive">
                                    ...
                                    <tr>
                                      <td>
                                        ...
                                        <?php }else{ ?>
                                           <textarea name="remark" cols="100" class="form-control"><?php echo e($overall_remark[0]->adhar_remark); ?></textarea>
                                        <?php } ?>
              ...
              <div class="tab">
                <input type="radio" name="css-tabs" id="tab-6" class="tab-switch">
                 <a href="index.php/sra/final/<?php echo e($hid); ?>" class="tab-label" style="color:#495057!important;">Final Submission</a>
...
<?php echo $__env->make('admin::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sraservices/Modules/Admin/Resources/views/sra/adhar.blade.php ENDPATH**/ ?>