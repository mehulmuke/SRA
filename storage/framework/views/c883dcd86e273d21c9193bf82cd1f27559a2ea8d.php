                  ...
                  <div style="padding:10px;">
                    ...
                    <div class="panel-group" id="accordion" role="tablist" aria-multiselectable="true">
                      <div class="panel panel-default">
                                  ...
                                  <table class="table table-borderless table-responsive">
                                    ...
                                    <tbody>
                                      ...
                                      <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                          <?php if($doc->year == '2000'): ?>
                                              <td width="10%"><?php echo e($doc->license_number); ?></td>
                                              <td width="10%"><?php echo e($doc->license_issue_date); ?></td>
                                              <td width="20%"><?php echo e($doc->organization_name); ?></td>
                                              <th width="20%"><?php echo e($doc->owner_name); ?></th>
                                              <td width="20%"><?php echo e($doc->address); ?></td>
                                              <td width="10%"><?php echo e($doc->valid_upto); ?></td>
                                          <?php endif; ?>
                                      <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                  <?php else: ?>
                                      <td width='10%'>Not Available</td>
                       ...
                       <div class="card">
                          <div class="card-body">
                            ...
                            ?>
                            <img src="http://sra-uat.apniamc.in/images/<?php echo e($hid); ?>_gumasta1.jpeg" style="height:320px;width:100%;" id="myImg" onerror="this.onerror=null;this.src='http://sra-uat.apniamc.in/images/noimage.jpg';">
                            <?php }else{ ?>
                      ...
                      <!-- ocr image end -->
                            ...
                            <form method="post" enctype="multipart/form-data" action="<?php echo e(route('admin.sra.store_integration_gumasta')); ?>">
                            <?php echo csrf_field(); ?>
                                        ...
                                        <tbody>
                                            <tr>
                                               ...
                                               <?php }else { ?>
                                                ...
                                                <td width="20%"><?php echo e(isset($int_data_2000->organisation_name) ? $int_data_2000->organisation_name : ''); ?></td>
                                                <td width="20%"><?php echo e(isset($int_data_2000->name) ? $int_data_2000->name : ''); ?></td>
                                                <td width="20%"><?php echo e(isset($int_data_2000->address) ? $int_data_2000->address : ''); ?></td>
                                                <td width="10%"><?php echo e(isset($int_data_2000->License_exp_date) ? $int_data_2000->License_exp_date : ''); ?></td>
                                               <?php } ?>
                  ...
                  <div class="card-body">
                    <div class="table-responsive" id="sra-table">
                        <table class="table table-borderless table-responsive">
                            <thead>
                              <tr>
                                <th width="10%" style="background-color:<?= $color_lic_no; ?>;color:#fff;padding: 5px !important;" >Number(<?php echo e($highestPercentageOfLicNo); ?>%)</th>
                                <th width="10%" style="background-color:<?= $color_issue_date; ?>;color:#fff;padding: 5px !important;" >Issued Date(<?php echo e($highestPercentageOfIssueDate); ?>%)</th>
                                <th width="20%" style="background-color:<?= $color_org_name; ?>;color:#fff;padding: 5px !important;" >Organization(<?php echo e($highestPercentageOfOrg); ?>%)</th>
                                <th width="20%" style="background-color:<?= $color_name; ?>;color:#fff;padding: 5px !important;" >Owner Name(<?php echo e($highestPercentageOfName); ?>%)</th>
                                <th width="20%"  style="background-color:<?= $color_address; ?>;color:#fff;padding: 5px !important;" >Address(<?php echo e($highestPercentageOfAddress); ?>%) </th></th>
                                <th width="10%"  style="background-color:<?= $color_valid; ?>;color:#fff;padding: 5px !important;" >Valid Up to(<?php echo e($highestPercentageOfvalidUpto); ?>%)</th>
                              </tr>
                            </thead>
                            <tbody>
                              ...
                              <form method="post" enctype="multipart/form-data" action="<?php echo e(route('admin.sra.storeremark_gumasta')); ?>">
                              <?php echo csrf_field(); ?>
                              ...
                              <tr>
                                ...
                                <select name="elg1" class="form-control" style="padding: 2px 1rem !important;">
                                    ...
                                    <option value="1" <?php echo e(isset($highestPercentageOfLicNo) && $highestPercentageOfLicNo < 100 ? 'selected' : ''); ?>>Manual</option>
                                    <option value="2" <?php echo e(isset($highestPercentageOfLicNo) && $highestPercentageOfLicNo == 100 ? 'selected' : ''); ?>>Auto</option>
                                </select>
                                </td>
                                <td width="10%">
                                <select name="elg2" class="form-control" style="padding: 2px 1rem !important;">
                                    <option value="0">-- Select Option --</option>
                                    <option value="1" <?php echo e(isset($highestPercentageOfIssueDate) && $highestPercentageOfIssueDate < 100 ? 'selected' : ''); ?>>Manual</option>
                                    <option value="2" <?php echo e(isset($highestPercentageOfIssueDate) && $highestPercentageOfIssueDate == 100 ? 'selected' : ''); ?>>Auto</option>
                                </select>
                                </td>
                                <td width="10%">
                                ...
                                <select name="elg5" class="form-control" style="padding: 2px 1rem !important;">
                                    <option value="0">-- Select Option --</option>
                                    <option value="1" <?php echo e(isset($highestPercentageOfvalidUpto) && $highestPercentageOfvalidUpto < 100 ? 'selected' : ''); ?>>Manual</option>
                                    <option value="2" <?php echo e(isset($highestPercentageOfvalidUpto) && $highestPercentageOfvalidUpto == 100 ? 'selected' : ''); ?>>Auto</option>
                                </select>
                                </td>
                                <?php } ?>
                              </tr>
                              ...
                              <tr>
                                 <?php if (isset($data_2000) ) { ?>
                                  <td width="10%"><?php echo e(isset($data_2000->remark_licanse_name) ? $data_2000->remark_licanse_name : ''); ?></td>
                                <td width="10%"><?php echo e(isset($data_2000->remark_licanse_issue_date) ? $data_2000->remark_licanse_issue_date : ''); ?></td>
                                <td width="20%"><?php echo e(isset($data_2000->remark_owner_org_name) ? $data_2000->remark_owner_org_name : ''); ?></td>
                                <td width="20%"><?php echo e(isset($data_2000->remark_owner_name) ? $data_2000->remark_owner_name : ''); ?></td>
                                  ...
                                  <td width="10%">
                                     <?php if (isset($data_2000) ) { 
                                      ...
                                      <select name="elg" class="form-control" style="padding: 2px 1rem !important;">
                                        ...
                                        <option value="3" <?php echo e(isset($data_2000->overall_eligibility) &&($data_2000->overall_eligibility == 2) ? 'selected' : ''); ?>> Unavailable</option>
                                    ...
                                    <td width="10%" colspan="5">
                                      ...
                                      <?php }else { ?>
                                        <textarea class="form-control" style="height: auto !important;" name="remark" cols="100" <?php echo e(isset($data_2000->overall_remark) ? 'readonly' : ''); ?>><?php echo e(isset($data_2000->overall_remark) ? $data_2000->overall_remark : $remark); ?></textarea>
                                      <?php } ?>
                                    </td>
                ...
                <div class="card">
                  <div class="card-body">
                   ...
                              </tr>
                              ...
                              <tr>
                                <?php if (isset($data_2000_ca) ) { ?>
                                  <td width="10%"><?php echo e(isset($data_2000_ca->remark_licanse_name) ? $data_2000_ca->remark_licanse_name : ''); ?></td>
                                <td width="10%"><?php echo e(isset($data_2000_ca->remark_licanse_issue_date) ? $data_2000_ca->remark_licanse_issue_date : ''); ?></td>
                                <td width="20%"><?php echo e(isset($data_2000_ca->remark_owner_org_name) ? $data_2000_ca->remark_owner_org_name : ''); ?></td>
                                <td width="20%"><?php echo e(isset($data_2000_ca->remark_owner_name) ? $data_2000_ca->remark_owner_name : ''); ?></td>
                              ...
                              <tr>
                                  <td width="10%">
                                    <?php if (isset($data_2000_ca) ) { 
                                      ...
                                      <select name="elg" class="form-control" style="padding: 2px 1rem !important;">
                                        <option value="0">-- Select Option --</option>
                                        <option value="1" <?php echo e(isset($data_2000t_ca->overall_eligibility) && ($data_2000_ca->overall_eligibility == 1) ? 'selected' : ''); ?> >Verified</option>
                                    ...
                                    <?php if (isset($data_2000_ca) ) { ?>
                                      ...
                                      <?php }else { ?>
                                        <textarea class="form-control" style="height: auto !important;" name="remark" cols="100" <?php echo e(isset($data_2000_ca->overall_remark) ? 'readonly' : ''); ?>><?php echo e(isset($data_2000_ca->overall_remark) ? $data_2000_ca->overall_remark :  $remark); ?></textarea>                                    <?php } ?>
                                    </td>
                    ...
                    <div class="table-responsive" id="sra-table">
                      <table class="table table-borderless table-responsive">
                        ...
                        <tbody>
                          ...
                          <?php if(count($documents) >= 1): ?>
                          <?php $__currentLoopData = $documents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <?php if($doc->year == '2011'): ?>
                                  <td width="10%"><?php echo e($doc->license_number); ?></td>
                                  <td width="10%"><?php echo e($doc->license_issue_date); ?></td>
                                  <td width="20%"><?php echo e($doc->organization_name); ?></td>
                                  <td width="20%"><?php echo e($doc->owner_name); ?></td>
                                  <td width="20%"><?php echo e($doc->address); ?></td>
                                  <td width="10%"><?php echo e($doc->valid_upto); ?></td>
                              <?php endif; ?>
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    ...
                    <div class="col-md-3">
                       <div class="card">
                          <div class="card-body">
                            ...
                            if(isset($documents)){
                            ?>
                            <img src="http://sra-uat.apniamc.in/images/<?php echo e($hid); ?>_gumasta2.jpeg" style="height:320px;width:100%;" id="myImg2" onerror="this.onerror=null;this.src='http://sra-uat.apniamc.in/images/noimage.jpg';">
                            <?php }else{ ?>
                              <img src="http://sra-uat.apniamc.in/images/noimage.jpg" style="height:320px;width:100%" >
                            <?php } ?>
                            <!-- start-->
                                        ...
                                        <tbody>
                                            <tr>
                                              ...
                                              <?php }else{ ?>
                                                ...
                                                <td width="20%"><?php echo e(isset($int_data_2000_2011->organisation_name) ? $int_data_2000_2011->organisation_name : ''); ?></td>
                                                <td width="20%"><?php echo e(isset($int_data_2000_2011->name) ? $int_data_2000_2011->name : ''); ?></td>
                                                <td width="20%"><?php echo e(isset($int_data_2000_2011->address) ? $int_data_2000_2011->address : ''); ?></td>
                                                <td width="10%"><?php echo e(isset($int_data_2000_2011->License_exp_date) ? $int_data_2000_2011->License_exp_date : ''); ?></td>
                                              <?php } ?>
                                            </tr>
                                            <tr>
                                              <?php 
                ...
                <div class="card">
                  <div class="card-body">
                   ...
                              </tr>
                              ...
                              <tr>
                                 <?php if (isset($data_2000_2011) ) { ?>
                                  <td width="10%"><?php echo e(isset($data_2000_2011->remark_licanse_name) ? $data_2000_2011->remark_licanse_name : ''); ?></td>
                                <td width="10%"><?php echo e(isset($data_2000_2011->remark_licanse_issue_date) ? $data_2000_2011->remark_licanse_issue_date : ''); ?></td>
                                <td width="20%"><?php echo e(isset($data_2000_2011->remark_owner_org_name) ? $data_2000_2011->remark_owner_org_name : ''); ?></td>
                                <td width="20%"><?php echo e(isset($data_2000_2011->remark_owner_name) ? $data_2000_2011->remark_owner_name : ''); ?></td>
                              ...
                              <tr>
                                  <td width="10%">
                                    ...
                                    <td width="10%" colspan="5">
                                      ...
                                      <?php }else { ?>
                                        <textarea class="form-control" style="height: auto !important;" name="remark" cols="100" <?php echo e(isset($data_2000_2011->overall_remark) ? 'readonly' : ''); ?>><?php echo e(isset($data_2000_2011->overall_remark) ? $data_2000_2011->overall_remark : $remark1); ?></textarea>                                    <?php } ?>
                                    </td>
                ...
                <div class="card">
                  <div class="card-body">
                   ...
                              </tr>
                              ...
                              <tr>
                                 <?php if (isset($data_2000_2011_ca) ) { ?>
                                  <td width="10%"><?php echo e(isset($data_2000_2011_ca->remark_licanse_name) ? $data_2000_2011_ca->remark_licanse_name : ''); ?></td>
                                <td width="10%"><?php echo e(isset($data_2000_2011_ca->remark_licanse_issue_date) ? $data_2000_2011_ca->remark_licanse_issue_date : ''); ?></td>
                                <td width="20%"><?php echo e(isset($data_2000_2011_ca->remark_owner_org_name) ? $data_2000_2011_ca->remark_owner_org_name : ''); ?></td>
                                <td width="20%"><?php echo e(isset($data_2000_2011_ca->remark_owner_name) ? $data_2000_2011_ca->remark_owner_name : ''); ?></td>
                                  ...
                                  <td width="10%">
                                     <?php if (isset($data_2000_2011_ca) ) { 
                                      ...
                                      <select name="elg" required class="form-control" style="padding: 2px 1rem !important;">
                                        ...
                                        <option value="2" <?php echo e(isset($data_2000_2011_ca->overall_eligibility) &&($data_2000_2011_ca->overall_eligibility == 2) ? 'selected' : ''); ?>> Unavailable</option>
                                      </select>
                                    <?php } ?>
                                    </td> 
                                    <td width="10%" colspan="5">
                ...
                <div class="card">
                    ...
                    <div class="col-md-3">
                      ...
                      <div class="card">
                          <div class="card-body">
                            ...
                            if(isset($documents)){
                            ?>
                            <img src="http://sra-uat.apniamc.in/images/<?php echo e($hid); ?>_gumasta3.jpeg" style="height:320px;width:100%;" id="myImg3"  onerror="this.onerror=null;this.src='http://sra-uat.apniamc.in/images/noimage.jpg';">
                            <?php }else{ ?>
                              <img src="http://sra-uat.apniamc.in/images/noimage.jpg" style="height:320px;width:100%;" >
                            <?php } ?>
                            <!-- start-->
                  ...
                  <form method="post" enctype="multipart/form-data" action="<?php echo e(route('admin.sra.store_integration_gumasta')); ?>">
                                        ...
                                        <tbody>
                                            <tr>
                                              <?php if(!isset($int_data_current)){ ?>
                                                ...
                                                <td width="20%"><?php echo e(isset($int_data_current->organisation_name) ? $int_data_current->organisation_name : ''); ?></td>
                                                <td width="20%"><?php echo e(isset($int_data_current->name) ? $int_data_current->name : ''); ?></td>
                                                <td width="20%"><?php echo e(isset($int_data_current->address) ? $int_data_current->address : ''); ?></td>
                                                <td width="10%"><?php echo e(isset($int_data_current->License_exp_date) ? $int_data_current->License_exp_date : ''); ?></td>
                                               <?php } ?>
                                            </tr>
                                            <tr>
                                              <?php 
                   ...
                              </tr>
                              ...
                              <tr>
                                <?php if (isset($data_current) ) { ?>
                                  <td width="10%"><?php echo e(isset($data_current->remark_licanse_name) ? $data_current->remark_licanse_name : ''); ?></td>
                                <td width="10%"><?php echo e(isset($data_current->remark_licanse_issue_date) ? $data_current->remark_licanse_issue_date : ''); ?></td>
                                <td width="20%"><?php echo e(isset($data_current->remark_owner_org_name) ? $data_current->remark_owner_org_name : ''); ?></td>
                                <td width="20%"><?php echo e(isset($data_current->remark_owner_name) ? $data_current->remark_owner_name : ''); ?></td>
                        ...
                        <table class="table table-borderless table-responsive">
                            ...
                            <tbody>
                              ...
                              <tr>
                                <?php if (isset($data_current_ca) ) { ?>
                                  <td width="10%"><?php echo e(isset($data_current_ca->remark_licanse_name) ? $data_current_ca->remark_licanse_name : ''); ?></td>
                                <td width="10%"><?php echo e(isset($data_current_ca->remark_licanse_issue_date) ? $data_current_ca->remark_licanse_issue_date : ''); ?></td>
                                <td width="20%"><?php echo e(isset($data_current_ca->remark_owner_org_name) ? $data_current_ca->remark_owner_org_name : ''); ?></td>
                                <td width="20%"><?php echo e(isset($data_current_ca->remark_owner_name) ? $data_current_ca->remark_owner_name : ''); ?></td>
                                ...
                                <td width="20%"><input type="text" required class="form-control" name="remark3_ca" value = "<?php echo e(isset($data_current_ca->remark_owner_org_name) ? $data_current_ca->remark_owner_org_name : ''); ?>" <?php echo e(isset($data_current_ca->remark_owner_org_name) ? 'readonly' : ''); ?> ></td>
                                 ...
                                 <td width="20%">
                                  <?php if(isset($data_current_ca->remark_owner_name)){?>
                                    <input type="text" class="form-control" name="remark6_ca" value = "<?php echo e($data_current_ca->remark_owner_name); ?>" >
                                  <?php } else { ?>
                                    <input type="text" class="form-control" name="remark6_ca" value = "" >
                                  <?php } ?>
                                </td>
