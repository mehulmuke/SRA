...
<?php echo e(Form::checkbox('enable_file_share', clean(trans('setting::attributes.enable_file_share')), clean(trans('setting::settings.form.user_can_share_files_other')), $errors, $settings)); ?><?php /**PATH C:\xampp\htdocs\sraservices_working\Modules/Setting/Resources/views/admin/settings/tabs/files.blade.php ENDPATH**/ ?>