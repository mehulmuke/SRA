...
<div class="main-header">
    <!-- Logo Header -->
    <div class="logo-header" data-background-color="<?php echo e(setting('theme_logo_header_color','blue')); ?>" style=" width: auto !important; color: aliceblue !important;
                    ...
                    <a class="dropdown-toggle profile-pic" data-toggle="dropdown" href="#" aria-expanded="false">
                        <div class="avatar-sm">
                            ...
                            <?php else: ?>
                                ...
                                <img src="http://sra-uat.apniamc.in/modules/admin/images/user-icon.png" alt="..." class="avatar-img rounded-circle">
                            <?php endif; ?>
                        </div>
                    </a>
                                    ...
                                    <div class="avatar-lg">
                                        ...
                                        <?php else: ?>
                                            <!-- <img src="<?php echo e(url('modules/admin/images/user-icon.png')); ?>" alt="..." class="avatar-img rounded"> -->
                                             <img src="http://sra-uat.apniamc.in/modules/admin/images/user-icon.png" alt="..." class="avatar-img rounded">
                                        <?php endif; ?>
...
<?php /**PATH /var/www/sra_annexure/Modules/Admin/Resources/views/include/header.blade.php ENDPATH**/ ?>