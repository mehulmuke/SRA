                      ...
                      <div class="card">
                        <div class="card-body">
                          ...
                          <?php $__currentLoopData = $query1; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div id="modal<?php echo e($value->DOCCategory); ?>" class="modal">
                                <div class="modal-content">
                                    <img class="full-image" src="" id="img<?php echo e($value->DOCCategory); ?>"/>
                                    <span class="close">&times;</span>
                                </div>
                              </div>
                              <?php if($value->DocumentContent): ?>
                                  <div class="col-md-3">
                                      <h3><?php echo e(str_replace("_"," ",$value->DOCCategory)); ?></h3>
                              ...
                              <script>
                                ...
                                var modal = document.getElementById('modal<?php echo e($value->DOCCategory); ?>');
                                var fullImage = modal.querySelector('.full-image');
                                var modalImg = document.getElementById("img<?php echo e($value->DOCCategory); ?>");
                  ...
                  <div class="col-md-12">
                      <div class="card">
                        <div class="card-body">
                          ...
                          <?php $__currentLoopData = $election_document; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div id="modal<?php echo e($value->voter_image); ?><?php echo e($value->year); ?>" class="modal">
                                <div class="modal-content">
                                    <img class="full-image" src="" />
                                    <span class="close">&times;</span>
                                </div>
                              </div>
                              <?php if($value->voter_image): ?>
                                  <div class="col-md-3">
                                    <?php
                                      $year_title = '';
                                      if($value->year == '2000')
                                    ...
                                    ?>
                                      <h3>Election Document <?php echo e($year_title); ?></h3>

                                      <img class="<?php echo e($value->voter_image); ?> thumbnail" src=" http://sra-uat.apniamc.in/images/<?php echo e($value->voter_image); ?>"
                              ...
                              <script>
                              // Get the modal and the full-size image
                              var modal = document.getElementById('modal<?php echo e($value->voter_image); ?><?php echo e($value->year); ?>');
                              var fullImage = modal.querySelector('.full-image');
                          ...
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          <?php $__currentLoopData = $electricity_document; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div id="modal<?php echo e($value->bill_image); ?><?php echo e($value->year); ?>" class="modal">
                              <div class="modal-content">
                                  <img class="full-image" src="" />
                                  <span class="close">&times;</span>
                              </div>
                            </div>
                            <?php if($value->bill_image): ?>
                                <div class="col-md-3">
                                    <?php
                                      $year_title = '';
                                      if($value->year == '2000')
                                      ...
                                      if($value->year == '2023')
                                        $year_title = 'Current Year';                                     
                                    ?>
                                    <h3>Electricity Document <?php echo e($year_title); ?></h3>

                                    <img class="<?php echo e($value->bill_image); ?> thumbnail" src=" http://sra-uat.apniamc.in/images/<?php echo e($value->bill_image); ?>"
                                        width='150' height='150' onerror="this.onerror=null;this.src='http://sra-uat.apniamc.in/images/noimage.jpg';"/>
                                </div>
                            <?php else: ?>
                            ...
                            <script>
                              // Get the modal and the full-size image
                              var modal = document.getElementById('modal<?php echo e($value->bill_image); ?><?php echo e($value->year); ?>');
                              var fullImage = modal.querySelector('.full-image');
                          ...
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          <?php $__currentLoopData = $agreement_document; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                          <div class="col-md-3">

                              <div id="modal<?php echo e($value->file); ?><?php echo e($value->year); ?>" class="modal">
                                <div class="modal-content">
                                    <img class="full-image" src="" />
                                    <span class="close">&times;</span>
                                </div>
                              ...
                              <?php if($value->file): ?>
                                     ...
                                     <?php
                                        ...
                                        $year_title = 'Current Year';                                     
                                      ?>
                                      <h3>Agreement Document <?php echo e($year_title); ?></h3>
                                      <?php 
                                        $agreements = array();
                          ...
                          <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                          <?php $__currentLoopData = $gumasta_document; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div id="modal<?php echo e($value->file); ?><?php echo e($value->year); ?>" class="modal">
                                <div class="modal-content">
                                    <img class="full-image" src="" />
                                    <span class="close">&times;</span>
                                  ...
                                  <div class="col-md-3">
                                    <?php
                                      ...
                                      if($value->year == '2023')
                                        $year_title = 'Current Year';                                     
                                    ?>
                                      <h3>Gumasta Document <?php echo e($year_title); ?></h3>

                                      <img class="<?php echo e($value->file); ?> thumbnail" src=" http://sra-uat.apniamc.in/images/<?php echo e($value->file); ?>"
                                          width='150' height='150' onerror="this.onerror=null;this.src='http://sra-uat.apniamc.in/images/noimage.jpg';"/>
                                  </div>
                              <?php else: ?>
                              ...
                              <script>
                              // Get the modal and the full-size image
                              var modal = document.getElementById('modal<?php echo e($value->file); ?><?php echo e($value->year); ?>');
                              var fullImage = modal.querySelector('.full-image');
                          ...
                          <?php $__currentLoopData = $photopass_document; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div id="modal<?php echo e($value->survey_receipt_image); ?><?php echo e($value->year); ?>" class="modal">
                                <div class="modal-content">
                                    <img class="full-image" src="" />
                                    <span class="close">&times;</span>
                                </div>
                              </div>
                              <?php if($value->survey_receipt_image): ?>
                                  <div class="col-md-3">
                                    <?php
                                      $year_title = '';
                                      if($value->year == '2000')
                                      ...
                                      if($value->year == '2023')
                                        $year_title = 'Current Year';                                     
                                    ?>
                                      <h3>Photopass Document <?php echo e($year_title); ?></h3>

                                      <img class="<?php echo e($value->survey_receipt_image); ?> thumbnail" src=" http://sra-uat.apniamc.in/images/<?php echo e($value->survey_receipt_image); ?>"
                                          width='150' height='150' onerror="this.onerror=null;this.src='http://sra-uat.apniamc.in/images/noimage.jpg';"/>
                                  </div>
                              <?php else: ?>
                              ...
                              <script>
                              // Get the modal and the full-size image
                              var modal = document.getElementById('modal<?php echo e($value->survey_receipt_image); ?><?php echo e($value->year); ?>');
                              var fullImage = modal.querySelector('.full-image');
                          ...
                          <?php $__currentLoopData = $adhar_document; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div class="col-md-3">

                                  <div id="modal<?php echo e($value->file); ?>" class="modal">
                                    <div class="modal-content">
                                        <img class="full-image" src="" />
                                        <span class="close">&times;</span>
                                    </div>
                              ...
                              <?php $__currentLoopData = $other_document; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <div id="modal<?php echo e($value->image); ?>" class="modal">
                                <div class="modal-content">
                                    <img class="full-image" src="" />
                                    <span class="close">&times;</span>
                                </div>
                              ...
                              <?php if($value->image): ?>
                                  ...
                                  <h3><?php echo e(ucwords(str_replace("_"," ",$value->document_type))); ?></h3>

                                      <img class="<?php echo e($value->image); ?> thumbnail" src=" http://sra-uat.apniamc.in/images/<?php echo e($value->image); ?>"
                                          width='150' height='150' onerror="this.onerror=null;this.src='http://sra-uat.apniamc.in/images/noimage.jpg';"/>
                                  </div>
                              <?php else: ?>
                              ...
                              <script>
                              // Get the modal and the full-size image
                              var modal = document.getElementById('modal<?php echo e($value->image); ?>');
                              var fullImage = modal.querySelector('.full-image');
...
<?php echo $__env->make('admin::layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/sraservices/Modules/Admin/Resources/views/sra/documentlisting.blade.php ENDPATH**/ ?>