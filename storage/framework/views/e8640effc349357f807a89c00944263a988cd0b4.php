           ...
           <div class="card">
                  ...
                  <div class="card-body">
                    <div class="table-responsive" id="sra-table">
                      <table class="table table-borderless table-responsive">
                        ...
                        <tbody>
                          <tr>
                            <td width="10%"><?php echo e(isset($documents[0]->sr_no)?$documents[0]->sr_no:'Not Available'); ?></td>
                            <td width="10%"><?php echo e(isset($documents[0]->document)?$documents[0]->document:'Not Available'); ?></td>
                            <td width="20%">
                            <?php 
                            ...
                            <td width="20%"><?php echo e(isset($documents[0]->seller_name)?$documents[0]->seller_name:'Not Available'); ?></td>
                  ...
                  <div class="card-body">
                    <div class="table-responsive" id="sra-table">
                        <table class="table table-borderless table-responsive">
                            <thead>
                                <tr>
                                    <th width="10%" style="background-color:<?= $color_srno; ?>;color:#fff;padding: 5px !important;"># (<?php echo e(round($highestPercentageOfSrno)); ?>%)</th>
                                    <th width="10%" style="background-color:<?= $color_doc; ?>;color:#fff;padding: 5px !important;">Type (<?php echo e(round($highestPercentageOfDoc)); ?>%) </th>
                                    <th width="20%" style="background-color:<?= $color_date; ?>;color:#fff;padding: 5px !important;">Date (<?php echo e(round($highestPercentageOfDate)); ?>%)</th>
                                    <th width="20%" style="background-color:<?= $color_sname; ?>;color:#fff;padding: 5px !important;">Seller (<?php echo e(round($highestPercentageOfSname)); ?>%)</th>
                                    <th width="10%" style="background-color:<?= $color_pname; ?>;color:#fff;padding: 5px !important;">Purchaser (<?php echo e(round($highestPercentageOfPname)); ?>%)</th>
                                    <th width="10%" style="background-color:<?= $color_rname; ?>;color:#fff;padding: 5px !important;">Relationship (<?php echo e(round($highestPercentageOfRname)); ?>%)</th>
                                  </tr>
                                  <tr>
                                <td width="10%"><?php echo e(isset($highestPercentageSrno)?$highestPercentageSrno:'Not Available'); ?></td>
                                 <td width="10%"><?php echo e(isset($highestPercentagedoc)?$highestPercentagedoc:'Not Available'); ?></td>
                                <td width="20%"><?php echo e(isset($highestPercentagedate)?$highestPercentagedate:'Not Available'); ?></td>
                                <td width="20%"><?php echo e(isset($highestPercentagesname)?$highestPercentagesname:'Not Available'); ?></td>
                                <td width="10%"><?php echo e(isset($highestPercentagepname)?$highestPercentagepname:'Not Available'); ?></td>
                                <td width="10%"><?php echo e(isset($highestPercentagername)?$highestPercentagername:'Not Available'); ?></td>
                              </tr>
                              <form method="post" enctype="multipart/form-data" action="<?php echo e(route('admin.sra.storeremark_agreement')); ?>">
                              <?php echo csrf_field(); ?>
                   ...
                              </tr>
                              ...
                              <tr>
                                <?php if (count($query_data) > 0) { ?>
                                <td width="10%"><?php echo e(isset($query_data[0]->remark_srno)?$query_data[0]->remark_srno:''); ?></td>
                                <td width="10%"><?php echo e(isset($query_data[0]->remark_type)?$query_data[0]->remark_type:''); ?></td>
                                <td width="20%"><?php echo e(isset($query_data[0]->remark_aggrement_date)?$query_data[0]->remark_aggrement_date:''); ?></td>
                                <td width="20%"><?php echo e(isset($query_data[0]->remark_seller_name)?$query_data[0]->remark_seller_name:''); ?></td>
                                <td width="10%"><?php echo e(isset($query_data[0]->remark_purchaser_name)?$query_data[0]->remark_purchaser_name:''); ?></td>
                ...
                <div class="card">
                  <div class="card-body">
                   ...
                              </tr>
                              ...
                              <tr>
                                 <?php if (count($recomm_remarks_ca) > 0) { ?>
                                <td width="10%"><?php echo e(isset($recomm_remarks_ca[0]->remark_srno)?$recomm_remarks_ca[0]->remark_srno:''); ?></td>
                                <td width="10%"><?php echo e(isset($recomm_remarks_ca[0]->remark_type)?$recomm_remarks_ca[0]->remark_type:''); ?></td>
                                <td width="20%"><?php echo e(isset($recomm_remarks_ca[0]->remark_aggrement_date)?$recomm_remarks_ca[0]->remark_aggrement_date:''); ?></td>
                                <td width="20%"><?php echo e(isset($recomm_remarks_ca[0]->remark_seller_name)?$recomm_remarks_ca[0]->remark_seller_name:''); ?></td>
            ...
            <div class="tab">
                <input type="radio" name="css-tabs" id="tab-7" class="tab-switch">
                 <a href="index.php/sra/adhar/<?php echo e($hid); ?>" class="tab-label" style="color:#495057!important;">Aadhar Card</a>
