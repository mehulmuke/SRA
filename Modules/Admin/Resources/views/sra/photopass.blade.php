...
// print_r($match_type_array);die;
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    @foreach ($query as $data)
                                                                        ...
                                                                        {{-- <td width="10%">{{ round($data->Area, 2) }}</td>
                                                                        <td width="10%">Not Available</td> --}}
                                                            ...
                                                            <tbody>
                                                                <?php  if(count($query3)>=1){ ?>
                                                                    @foreach ($query3 as $row)
                                                                        <tr>
                                                                            <td width="10%">{{ $row->survey_receipt_no }}</td>
                                                                            <td width="20%">{{ $row->name_as_per_survey_receipt }}</td>
                                                                            <td width="20%">{{ $row->address_as_per_survey_receipt }}</td>
                                                                            {{-- <td width="10%">{{ $row->area_of_hut }}</td>
                                                                            <td width="10%">{{ $row->land_ownership }}</td> --}}
                                                                            <td width="10%">{{ $row->usage_type_of_hut }}</td>
                            ...
                            if(count($query3)>0){
                            ?>
                                                    <img src="http://localhost/Newfolder/sraservices/images/{{ $hid }}_survey_receipt.jpeg"
                                                ...
                                                <table class="table table-borderless table-responsive">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            @if (isset($result->ApplicationNo))
            <td width="10%">{{ $result->ApplicationNo }}</td>
        @else
            <td width="10%"></td>
        @endif

        @if (isset($result->NameOfSlumOwner))
            <td width="20%">{{ $result->NameOfSlumOwner }}</td>
        @else
            <td width="20%"></td>
        @endif

        @if (isset($result->SlumNameAdd))
            <td width="20%">{{ $result->SlumNameAdd }}</td>
        @else
            <td width="10%"></td>
        @endif

        {{-- Use of Slum --}}
        @if (isset($result->UseOfSlum))
            @if ($result->UseOfSlum == 0)
                <td width="10%">Residential</td>
            @elseif ($result->UseOfSlum == 1)
        ...
        @endif
                                                        ...
                                                        <script>
                                                            ...
                                                            @if (isset($result->OfficeUseImage))
                                                            <td width="10%">
                                                            @php
                                                            ...
                                                            <?php
                                                              if(isset($highestPercentageOfApplicationNo) && $highestPercentageOfApplicationNo == 100)
                                                              {
                                                                ...
                                                                <select name="elg1" class="form-control"
                                                                    ...
                                                                    <option value="1"
                                                                        {{ isset($highestPercentageOfApplicationNo) && $highestPercentageOfApplicationNo < 100 ? 'selected' : '' }}>
                                                                        Manual</option>
                                                                    <option value="2"
                                                                        {{ isset($highestPercentageOfApplicationNo) && $highestPercentageOfApplicationNo == 100 ? 'selected' : '' }}>
                                                                        Auto</option>
                                                            ...
                                                            if(isset($highestPercentageOfName) && $highestPercentageOfName == 100)
                                                              {
                                                                ...
                                                                <select name="elg2" class="form-control"
                                                                    ...
                                                                    <option value="0">-- Select Option --</option>
                                                                    <option value="1"
                                                                        {{ isset($highestPercentageOfName) && $highestPercentageOfName < 100 ? 'selected' : '' }}>
                                                                        Manual</option>
                                                                    <option value="2"
                                                                        {{ isset($highestPercentageOfName) && $highestPercentageOfName == 100 ? 'selected' : '' }}>
                                                                        Auto</option>
                                                            ...
                                                            if(isset($highestPercentageOfAddress) && $highestPercentageOfAddress == 100)
                                                              {
                                                                ...
                                                                <select name="elg3" class="form-control"
                                                                    ...
                                                                    <option value="0">-- Select Option --</option>
                                                                    <option value="1"
                                                                        {{ isset($highestPercentageOfAddress) && $highestPercentageOfAddress < 100 ? 'selected' : '' }}>
                                                                        Manual</option>
                                                                    <option value="2"
                                                                        {{ isset($highestPercentageOfAddress) && $highestPercentageOfAddress == 100 ? 'selected' : '' }}>
                                                                        Auto</option>
                                                            ...
                                                            if(isset($highestPercentageOfType) && $highestPercentageOfType == 100)
                                                              {
                                                                ...
                                                                <select name="elg6" class="form-control"
                                                                    ...
                                                                    <option value="0">-- Select Option --</option>
                                                                    <option value="1"
                                                                        {{ isset($highestPercentageOfType) && $highestPercentageOfType < 100 ? 'selected' : '' }}>
                                                                        Manual</option>
                                                                    <option value="2"
                                                                        {{ isset($highestPercentageOfType) && $highestPercentageOfType == 100 ? 'selected' : '' }}>
                                                                        Auto</option>
                                                        ...
                                                        <tr>
                                                          ...
                                                          ?>
                                                            <form method="POST" enctype="multipart/form-data"
                                                                action="{{ route('admin.sra.storeremark_photopass', ['hid' => $hid]) }}">
                                                                @csrf
                                                      ...
                                                      <tr>
                                                        <td width="10%">
                                                         ...
                                                         <td width="10%" colspan="5">
                                                           ...
                                                           <?php } else  { ?>
                                                           <textarea name="remark" {{ isset($query_data[0]->overall_remark) ? 'readonly' : '' }} cols="100">{{ isset($query_data[0]->overall_remark) ? $query_data[0]->overall_remark : $remark }}</textarea>
                                                         <?php } ?>
                                                         </td>
                                                   </tr>
                                                   @hasAccess('admin.sra.vendor_remark')
                                        ...
                                        <tr>
                                            ...
                                            <?php
                                                ...
                                                <select name="elg4" class="form-control"
                                                    ...
                                                    <option value="0">-- Select Option --</option>
                                                    <option value="1"
                                                        {{ isset($highestPercentageOfArea) && $highestPercentageOfArea < 100 ? 'selected' : '' }}>
                                                        Manual</option>
                                                    <option value="2"
                                                        {{ isset($highestPercentageOfArea) && $highestPercentageOfArea == 100 ? 'selected' : '' }}>
                                                        Auto</option>
                                      ...
                                      <tr>
                                        <td width="10%">
                                         ...
                                         <?php } else { ?>
                                           ...
                                           <select name="elg" class="form-control" style="padding: 2px 1rem !important;">
                                             <option value="0">-- Select Option --</option>
                                             <option value="1" {{ isset($query_data_ca[0]->overall_eligibility) && ($query_data_ca[0]->overall_eligibility == 1) ? 'selected' : '' }}>Verified</option>
                                             <option value="2" {{ isset($query_data_ca[0]->overall_eligibility) && ($query_data_ca[0]->overall_eligibility == 2) ? 'selected' : '' }}>Not Matched</option>
                                             <option value="3" {{ isset($query_data_ca[0]->overall_eligibility) && ($query_data_ca[0]->overall_eligibility == 2) ? 'selected' : '' }}>Unavailable</option>
                                         ...
                                         <td width="10%" colspan="5">
                                           <?php if (count($query_data_ca) > 0) { ?>
                                             {{ isset($query_data_ca[0]->overall_remark) ? $query_data_ca[0]->overall_remark : 'Not Available' }}
                                           <?php } else  { ?>
                                           <textarea name="remark" {{ isset($query_data_ca[0]->overall_remark) ? 'readonly' : '' }} cols="100">{{ isset($query_data_ca[0]->overall_remark) ? $query_data_ca[0]->overall_remark : $remark}}</textarea>
                                         <?php } ?>
                                         </td>
                                   </tr>
                    ...
                    <!-- ca recommendation end -->
                                    ...
                                    {{-- Code start here Overall remark --}}
                                    <div class="panel panel-default">
                                                  ...
                                                  <table class="table table-borderless table-responsive">
                                                    ...
                                                    <tr>
                                                      <td>
                                                        ...
                                                        <?php }else{ ?>
                                                           <textarea name="remark" cols="100" class="form-control">{{$overall_remark[0]->photopass_remark}}</textarea>
                                                        <?php } ?>
                                                      </div>
                                                      </td>
                                                    </tr>
