...
@component('admin::include.page.header')
    @slot('title', clean(trans('admin::sra.uplodemissingdocument')))
    <li class="nav-item">
        <a href="#">
            {{ clean(trans('admin::sra.uplodemissingdocument')) }}
        </a>
    </li>
@endcomponent
@section('content')
<div class="table-responsive" id="sra-table" >
    ...
    <div class="rows" style="display:flex">
        <div class="table-responsive col-sm-4" id="sra-table">
            <form method="POST" enctype="multipart/form-data" action="{{ route('admin.sra.storemissingdocument') }}">
                @csrf
                ...
                <div style='display:none;' id='photopassdiv'>
                    <div class="card">
                        <div class="card-body">
                            ...
                            {{-- <div class="form-group">
                                <label class='form-control' for='land_ownership'>Land Ownership:</label>
                                <input class='form-control' type='text' name='land_ownership' id='land_ownership'>
                            </div>
                            <div class="form-group">
                                <label class='form-control' for='area_of_hut'>Area of Hut as per Survey Receipt: </label>
                                <input class='form-control' type='text' name='area_of_hut' id='area_of_hut'>
                            </div> --}}
                        </div>
                    </div>
                </div>
