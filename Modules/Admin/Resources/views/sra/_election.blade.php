                ...
                <div class="card-body">
                    <div class="table-responsive" id="sra-table">
                        <div class="tab">
                            ...
                            <label for="tab-1" class="tab-label">Election</label>
                    ...
                    <div class="table-responsive" id="sra-table">
                      <table class="table table-borderless table-responsive">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ route('admin.sra.storeremark_election') }}">
                          ...
                          <tr>
                              <td width="10%"><input type="text" name="remark1" value = "{{ isset($data_2000->remark_name) ? $data_2000->remark_name : '' }}" {{ isset($data_2000->remark_name) ? 'readonly' : '' }}></td>
                              <td width="20%"><input type="text" name="remark2" value = "{{ isset($data_2000->remark_address) ? $data_2000->remark_address : '' }}" {{ isset($data_2000->remark_address) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark3" value = "{{ isset($data_2000->remark_number) ? $data_2000->remark_number : '' }}" {{ isset($data_2000->remark_number) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark4" value = "{{ isset($data_2000->remark_type) ? $data_2000->remark_type : '' }}" {{ isset($data_2000->remark_type) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark5" value = "{{ isset($data_2000->remark_const_no) ? $data_2000->remark_const_no : '' }}" {{ isset($data_2000->remark_const_no) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark6" value = "{{ isset($data_2000->remark_sr_no) ? $data_2000->remark_sr_no : '' }}" {{ isset($data_2000->remark_sr_no) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark7" value = "{{ isset($data_2000->remark_part_no) ? $data_2000->remark_part_no : '' }}" {{ isset($data_2000->remark_part_no) ? 'readonly' : '' }}></td>
                    ...
                    <div class="table-responsive" id="sra-table">
                      <table class="table table-borderless table-responsive">
                        ...
                        <form method="post" enctype="multipart/form-data" action="{{ route('admin.sra.storeremark_election') }}">
                          ...
                          <tr>
                              <td width="10%"><input type="text" name="remark1" value = "{{ isset($data_2000_2011->remark_name) ? $data_2000_2011->remark_name : '' }}" {{ isset($data_2000_2011->remark_name) ? 'readonly' : '' }}></td>
                              <td width="20%"><input type="text" name="remark2" value = "{{ isset($data_2000_2011->remark_address) ? $data_2000_2011->remark_address : '' }}" {{ isset($data_2000_2011->remark_address) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark3" value = "{{ isset($data_2000_2011->remark_number) ? $data_2000_2011->remark_number : '' }}" {{ isset($data_2000_2011->remark_number) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark4" value = "{{ isset($data_2000_2011->remark_type) ? $data_2000_2011->remark_type : '' }}" {{ isset($data_2000_2011->remark_type) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark5" value = "{{ isset($data_2000_2011->remark_const_no) ? $data_2000_2011->remark_const_no : '' }}" {{ isset($data_2000_2011->remark_const_no) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark6" value = "{{ isset($data_2000_2011->remark_sr_no) ? $data_2000_2011->remark_sr_no : '' }}" {{ isset($data_2000_2011->remark_sr_no) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark7" value = "{{ isset($data_2000_2011->remark_part_no) ? $data_2000_2011->remark_part_no : '' }}" {{ isset($data_2000_2011->remark_part_no) ? 'readonly' : '' }}></td>
                  ...
                  <div class="card-body">
                    <div class="table-responsive" id="sra-table">
                      <table class="table table-borderless table-responsive">
                        ...
                        <tr>
                              <td width="10%"><input type="text" name="remark1" value = "{{ isset($data_current->remark_name) ? $data_current->remark_name : '' }}" {{ isset($data_current->remark_name) ? 'readonly' : '' }}></td>
                              <td width="20%"><input type="text" name="remark2" value = "{{ isset($data_current->remark_address) ? $data_current->remark_address : '' }}" {{ isset($data_current->remark_address) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark3" value = "{{ isset($data_current->remark_number) ? $data_current->remark_number : '' }}" {{ isset($data_current->remark_number) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark4" value = "{{ isset($data_current->remark_type) ? $data_current->remark_type : '' }}" {{ isset($data_current->remark_type) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark5" value = "{{ isset($data_current->remark_const_no) ? $data_current->remark_const_no : '' }}" {{ isset($data_current->remark_const_no) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark6" value = "{{ isset($data_current->remark_sr_no) ? $data_current->remark_sr_no : '' }}" {{ isset($data_current->remark_sr_no) ? 'readonly' : '' }}></td>
                              <td width="10%"><input type="text" name="remark7" value = "{{ isset($data_current->remark_part_no) ? $data_current->remark_part_no : '' }}" {{ isset($data_current->remark_part_no) ? 'readonly' : '' }}></td>
