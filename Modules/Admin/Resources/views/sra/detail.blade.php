...
@foreach($query as $data)
                 ...
                 <input type="hidden" name="hid_val" id="hid_val" value="{{$hid}}">
                 @endforeach
    <div class="row">
        <div class="col-md-12">
          <!-- tab start-->
                    ...
                    <div class="table-responsive" id="sra-table">
                      <table class="table table-borderless table-responsive">
                        ...
                        <tbody>
                          <tr>
                            @foreach($query as $data)
                              <td width="10%">{{$data->HUTOWNERNAME}} <input type="hidden" name="oname" id="oname" value="{{$data->HUTOWNERNAME}}" /></td>
                              <td width="20%">{{$data->Address}} <input type="hidden" name="add" id="add" value="{{$data->Address}}" /></td>
                              <td width="10%">{{$data->PropertyType}}<input type="hidden" name="ptype" id="ptype" value="{{$data->PropertyType}}" /></td>
                  ...
                  <div class="card-body">
                      ...
                      <table class="table table-borderless table-responsive">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td width="10%">{{ $data->elector_name }}</td>
                            <td width="20%">{{ $data->elector_address}} </td>
                            <td width="10%">{{ $data->category }}</td>
                            <td width="10%">Adani Electricity</td>
                            <td width="10%">{{ $data->ca_number }}</td>
                            <td width="10%">{{ $data->bill_date  }}</td>
                            @endforeach
                            <?php } else{ ?>
                               <td width="10%">Not Available</td>
                    ...
                    <div class="col-md-3">
                      ...
                      <div class="card">
                            ...
                            // if(count($query3)==1){
                            ?>
                            <img src="http://sra-uat.apniamc.in/images/{{$hid}}_light_bill1.jpeg" style="height:320px;width:100%;" id="myImg1" onerror="this.onerror=null;this.src='http://sra-uat.apniamc.in/images/noimage.jpg';">
                            <?php //}else{ ?>
                  ...
                  <div class="card-body">
                    <div class="table-responsive" id="sra-table">
                      ...
                      <table class="table table-borderless table-responsive">
                        <thead>
                          <tr>
                            <th width="10%" style="background-color:<?= $color_name; ?>;color:#fff;padding: 5px !important;">Owner Name ({{round($highestPercentageOfName1)}}%)</th>
                            <th width="20%" style="background-color:<?= $color_address; ?>;color:#fff;padding: 5px !important;">Address ({{round($highestPercentageOfAddress1)}}%)</th>
                            <th width="10%" style="background-color:<?= $color_category; ?>;color:#fff;padding: 5px !important;">Category ({{round($highestPercentageOfCategory1)}}%)</th>
                            <th width="10%" style="background-color:<?= $color_service_provider; ?>;color:#fff;padding: 5px !important;">Service Provider ({{round($highestPercentageOfservice_provider1)}}%)</th>
                            <th width="10%" style="background-color:<?= $color_ca; ?>;color:#fff;padding: 5px !important;">CA No ({{round($highestPercentageOfca1)}}%)</th>
                            <th width="10%" style="background-color:<?= $color_bill_date; ?>;color:#fff;padding: 5px !important;">Bill Date ({{round($highestPercentageOfbill_date1)}}%)</th>
                          </tr>
                        </thead>
                        <tbody>
                       ...
                       <!--  <tr>
                        ...
                        <tr>
                          ...
                          <select name="elg3" class="form-control" style="padding: 2px 1rem !important;">
                              <option value="0">-- Select Option --</option>
                              <option value="1" {{ isset($highestPercentageOfCategory1) && $highestPercentageOfCategory1 < 100 ? 'selected' : '' }}>Manual</option>
                              <option value="2" {{ isset($highestPercentageOfCategory1) && $highestPercentageOfCategory1 == 100 ? 'selected' : '' }}>Auto</option>
                          </select>
                          </td>
                          <td width="10%">
                          <select name="elg4" class="form-control" style="padding: 2px 1rem !important;">
                              <option value="0">-- Select Option --</option>
                              <option value="1" {{ isset($highestPercentageOfservice_provider1) && $highestPercentageOfservice_provider1 < 100 ? 'selected' : '' }}>Manual</option>
                              <option value="2"  {{ isset($highestPercentageOfservice_provider1) && $highestPercentageOfservice_provider1 == 100 ? 'selected' : '' }}>Auto</option>
                          </select>
                          </td>
                          <td width="10%">
                          <select name="elg5" class="form-control" style="padding: 2px 1rem !important;">
                              <option value="0">-- Select Option --</option>
                              <option value="1" {{ isset($highestPercentageOfca1) && $highestPercentageOfca1 < 100 ? 'selected' : '' }}>Manual</option>
                              <option value="2" {{ isset($highestPercentageOfca1) && $highestPercentageOfca1 == 100 ? 'selected' : '' }}>Auto</option>
                          </select>
                          </td>
                          <td width="10%">
                          <select name="elg6" class="form-control" style="padding: 2px 1rem !important;">
                              <option value="0">-- Select Option --</option>
                              <option value="1" {{ isset($highestPercentageOfbill_date1) && $highestPercentageOfbill_date1 < 100 ? 'selected' : '' }}>Manual</option>
                              <option value="2" {{ isset($highestPercentageOfbill_date1) && $highestPercentageOfbill_date1 == 100 ? 'selected' : '' }}>Auto</option>
                          </select>
                          </td> 
                        <?php } ?>
                        </tr>
                        ...
                        <tr>
                          <?php if (isset($data_2000) ) { ?>
                              <td width="10%">{{ isset($data_2000->remark_name) ? $data_2000->remark_name : '' }}</td>
                              <td width="20%">{{ isset($data_2000->remark_address) ? $data_2000->remark_address : '' }}</td>
                              <td width="10%">{{ isset($data_2000->remark_category) ? $data_2000->remark_category : '' }}</td>
                              <td width="10%">{{ isset($data_2000->remark_serviceprovider) ? $data_2000->remark_serviceprovider : '' }}</td>
                             ...
                             <td width="10%">
                              <?php if (isset($data_2000) ) { 
                                ...
                                <select name="elg" class="form-control" style="padding: 2px 1rem !important;">
                                  ...
                                  <option value="3" {{ isset($data_2000_ca->overall_eligibility) &&($data_2000->overall_eligibility == 3) ? 'selected' : '' }}>Unavailable</option>
                                </select>
                              <?php } ?>
                              </td> 
                      ...
                      <div class="card-body">
                        <div class="table-responsive" id="sra-table">
                          <table class="table table-borderless table-responsive">
                            ...
                            <tr>
                              <?php if (isset($data_2000_ca) ) { ?>
                              <td width="10%">{{ isset($data_2000_ca->remark_name) ? $data_2000_ca->remark_name : '' }}</td>
                              <td width="20%">{{ isset($data_2000_ca->remark_address) ? $data_2000_ca->remark_address : '' }}</td>
                              <td width="10%">{{ isset($data_2000_ca->remark_category) ? $data_2000_ca->remark_category : '' }}</td>
                              <td width="10%">{{ isset($data_2000_ca->remark_serviceprovider) ? $data_2000_ca->remark_serviceprovider : '' }}</td>
                  ...
                  <div class="card-body">
                    ...
                    <div class="col-md-3">
                      ...
                      <div class="card">
                            ...
                            // if(count($query4)==1){
                            ?>
                            <img src="http://sra-uat.apniamc.in/images/{{$hid}}_light_bill2.jpeg" style="height:320px;width:100%;" id="myImg2" onerror="this.onerror=null;this.src='http://sra-uat.apniamc.in/images/noimage.jpg';">
                            <?php //}else{ ?>
                              <!-- <img src="http://sra-uat.apniamc.in/images/noimage.jpg" style="height:320px;width:250px;" > -->
                            <?php// } ?>
                            <!-- start-->
                  ...
                  <div class="card-body">
                    <div class="table-responsive" id="sra-table">
                      ...
                      <table class="table table-borderless table-responsive">
                        ...
                        @endHasAccess
                         <?php if (isset($data_2000_2011) ) { ?>
                              <td width="10%">{{ isset($data_2000_2011->remark_name) ? $data_2000_2011->remark_name : '' }}</td>
                              <td width="20%">{{ isset($data_2000_2011->remark_address) ? $data_2000_2011->remark_address : '' }}</td>
                              <td width="10%">{{ isset($data_2000_2011->remark_category) ? $data_2000_2011->remark_category : '' }}</td>
                              <td width="10%">{{ isset($data_2000_2011->remark_serviceprovider) ? $data_2000_2011->remark_serviceprovider : '' }}</td>
                      ...
                      <div class="card-body">
                        <div class="table-responsive" id="sra-table">
                          ...
                          <select name="elg6" class="form-control" style="padding: 2px 1rem !important;">
                            ...
                            <tr>
                              <?php if (isset($data_2000_2011_ca) ) { ?>
                              <td width="10%">{{ isset($data_2000_2011_ca->remark_name) ? $data_2000_2011_ca->remark_name : '' }}</td>
                              <td width="20%">{{ isset($data_2000_2011_ca->remark_address) ? $data_2000_2011_ca->remark_address : '' }}</td>
                              <td width="10%">{{ isset($data_2000_2011_ca->remark_category) ? $data_2000_2011_ca->remark_category : '' }}</td>
                              <td width="10%">{{ isset($data_2000_2011_ca->remark_serviceprovider) ? $data_2000_2011_ca->remark_serviceprovider : '' }}</td>
                                ...
                                <td width="10%">
                                  <?php if (isset($data_2000_2011_ca) ) { 
                                    ...
                                    <select name="elg" class="form-control" style="padding: 2px 1rem !important;">
                                      ...
                                      <option value="3" {{ isset($data_2000_2011_ca->overall_eligibility) && ($data_2000_2011_ca->overall_eligibility == 3) ? 'selected' : '' }}>Unavailable</option>
                                    </select>
                                  <?php } ?>
                                  </td> 
                                  <td width="10%" colspan="5">
                  ...
                  <div class="card-body">
                      ...
                      <table class="table table-borderless table-responsive">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td width="10%">{{ isset($data->elector_name)?$data->elector_name:'Not Available' }}</td>
                            <td width="20%">{{ $data->elector_address}} </td>
                            <td width="10%">{{ $data->category }}</td>
                            <td width="10%">Adani Electricity</td>
                            <td width="10%">{{ $data->ca_number }}</td>
                    ...
                    <div class="col-md-3">
                      ...
                      <div class="card">
                            ...
                            // if(count($query5)==1){
                            ?>
                            <img src="http://sra-uat.apniamc.in/images/{{$hid}}_light_bill3.jpeg" style="height:320px;width:100%;" id="myImg" onerror="this.onerror=null;this.src='http://sra-uat.apniamc.in/images/noimage.jpg';">
                            <?php //}else{ ?>
                              <!-- <img src="http://sra-uat.apniamc.in/images/noimage.jpg" style="height:320px;width:250px;" > -->
                            <?php// } ?>
                            <!-- start-->
                  ...
                  <div class="card-body">
                    <div class="table-responsive" id="sra-table">
                      ...
                      <table class="table table-borderless table-responsive">
                        ...
                        @endHasAccess
                         <?php if (isset($data_current) ) { ?>
                              <td width="10%">{{ isset($data_current->remark_name) ? $data_current->remark_name : '' }}</td>
                              <td width="20%">{{ isset($data_current->remark_address) ? $data_current->remark_address : '' }}</td>
                              <td width="10%">{{ isset($data_current->remark_category) ? $data_current->remark_category : '' }}</td>
                              <td width="10%">{{ isset($data_current->remark_serviceprovider) ? $data_current->remark_serviceprovider : '' }}</td>
                        ...
                        <tr>
                            ...
                            <td width="10%" colspan="5">
                              <?php if (isset($data_current) ) { ?>
                                ...
                                <?php }else { ?>
                                  <textarea style="height:auto !important;" class="form-control" name="remark" cols="100" > {{ isset($data_current->overall_remark) ? $data_current->overall_remark : $remark3}}</textarea>
                            <?php } ?>
                            </td>
                    ...
                    <div class="card">
                      <div class="card-body">
                        ...
                        <?php } ?>
                            ...
                            <tr>
                              <?php if (isset($data_current_ca) ) { ?>
                              <td width="10%">{{ isset($data_current_ca->remark_name) ? $data_current_ca->remark_name : '' }}</td>
                              <td width="20%">{{ isset($data_current_ca->remark_address) ? $data_current_ca->remark_address : '' }}</td>
                              <td width="10%">{{ isset($data_current_ca->remark_category) ? $data_current_ca->remark_category : '' }}</td>
                              <td width="10%">{{ isset($data_current_ca->remark_serviceprovider) ? $data_current_ca->remark_serviceprovider : '' }}</td>
