            ...
            <!-- start -->
              ...
              <div class="col-md-3">
                 ...
                 <div class="card">
                            ...
                            if(count($query3)==1){
                            ?>
                            <img src="http://sra-uat.apniamc.in/images/{{$hid}}_voter_id1.jpeg" style="height:320px;width:100%;" id="myImg" onerror="this.onerror=null;this.src='http://sra-uat.apniamc.in/images/noimage.jpg';">
                            <?php }else{ ?>
                          ...
                          <div class="card">
                            <div class="card-body">
                              ...
                              ?>
                                              ...
                                              <tr>
                                                  <td width="10%">{{isset($name2000)?str_replace("Elector s Name","",$name2000):'Not Available'}}</td>
                                                  <td width="20%">{{isset($address2000)?$address2000:'Not Available'}} </td>
                                                  <td width="10%">{{isset($voterid2000)?$voterid2000:'Not Available'}}</td>
                                                  <td width="10%">
                  ...
                  <div class="card-body">
                    <div class="table-responsive" id="sra-table">
                      <table class="table table-borderless table-responsive">
                        ...
                        <thead>
                            <tr>
                              <th width="10%" style="background:<?= $color_name; ?>;color:#fff;">Owner Name({{round($highestPercentageOfName)}}%)</th>
                              <th width="20%" style="background:<?= $color_address; ?>;color:#fff;">Address({{round($highestPercentageOfAddress)}}%)</th>
                              <th width="10%" style="background:<?= $color_num; ?>;color:#fff;">Elector Number({{round($highestPercentageOfNum)}}%)</th>
                              <th width="10%" style="background:<?= $color_type; ?>;color:#fff;">Document Type({{round($highestPercentageOfType)}}%)</th>
                              <th width="10%" style="background:<?= $color_const; ?>;color:#fff;">Constitution No.({{round($highestPercentageOfconst)}}%)</th>
                              <th width="10%" style="background:<?= $color_sr; ?>;color:#fff;">Sr No.({{round($highestPercentageOfSrno)}}%)</th>
                              <th width="10%" style="background:<?= $color_part; ?>;color:#fff;">Part No.({{round($highestPercentageOfPart)}}%)</th>
                            </tr>
                          </thead>
                          <tbody>
                            <tr>
                        ...
                        ?>
                          ...
                          <tr>
                            <td width="10%">
                              @if (isset($data_2000->overall_eligibility))
                                {{ $data_2000->overall_eligibility === 1 ? 'Verified' : ($data_2000->overall_eligibility === 2 ? 'Not Matched' : 'Unavailable') }}
                              @else
                                <select name="elg" class="form-control" style="padding: 2px 1rem !important;">
                                  ...
                                  <option value="3" {{ isset($data_2000->overall_eligibility) && ($data_2000->overall_eligibility == 3) ? 'selected' : '' }}>Unavailable</option>
                                </select>
                              @endif
                            </td> 
                            <td width="10%" colspan="6">
                              @if (isset($data_2000->overall_remark))
                                {{ $data_2000->overall_remark }}
                              @else
                              <textarea class="form-control" style="height:auto!important;"  name="remark" {{ isset($data_2000->overall_remark) ? 'readonly' : '' }} cols="100">{{ isset($data_2000->overall_remark) ? $data_2000->overall_remark : $remark1 }}</textarea>                              @endif
                            </td>
                          </tr>

                        <tr>
                        @hasAccess('admin.sra.vendor_remark')
                            <td colspan="6"><br/><button id="submitBtn" type ="submit" class="btn btn-primary ml-auto btn-actions btn-create" @if(isset($data_2000->overall_remark)) hidden @endif>Submit</button></td>
                        @endHasAccess
                    </tr>
                    ...
                    <div class="table-responsive" id="sra-table">
                      <table class="table table-borderless table-responsive">
                        ...
                        <tr>
                          ...
                          <tr>
                          <td width="10%">
                            @if(isset($data_2000_ca->overall_eligibility))
                              {{ $data_2000_ca->overall_eligibility == 1 ? 'Verified' : ($data_2000_ca->overall_eligibility == 2 ? 'Not Matched' : 'Unavailable') }}
                            @else
                              <select name="elg" class="form-control" style="padding: 2px 1rem !important;">
                                <option value="0">-- Select Option --</option>
                            ...
                            @endif
                              ...
                              <td width="10%" colspan="6">
                                      @if(isset($data_2000_ca->overall_remark))
                                        {{ $data_2000_ca->overall_remark }}
                                      @else
                                      <textarea class="form-control" style="height:auto!important;" name="remark" cols="100"> {{ isset($data_2000_ca->overall_remark) ? $data_2000_ca->overall_remark :  $remark1}}</textarea>
                                      @endif
                                    </td>
                            </tr>
                        <!-- <tr>
                ...
                ?>
                 ...
                 <div class="card">
                          ...
                          <?php 
                            if(count($query4)==1){
                            ?>
                            <img src="http://sra-uat.apniamc.in/images/{{$hid}}_voter_id2.jpeg" style="height:320px;width:100%;" id="myImg" onerror="this.onerror=null;this.src='http://sra-uat.apniamc.in/images/noimage.jpg';">
                            <?php }else{ ?>
                              <img src="http://sra-uat.apniamc.in/images/noimage.jpg" style="height:320px;width:100%;" >
                            <?php } ?>
                                    ...
                                    <div class="table-responsive" id="sra-table">
                                      <table class="table table-borderless table-responsive">
                                        ...
                                        <tbody>
                                                ...
                                                <tr>
                                                  <td width="10%">{{isset($name2011)?str_replace("Elector s Name","",$name2011):'Not Available'}}</td>
                                                  <td width="20%">{{isset($address2011)?$address2011:'Not Available'}} </td>
                                                  <td width="10%">{{isset($voterid2011)?$voterid2011:'Not Available'}}</td>
                                                  <td width="10%">
                    ...
                    <div class="table-responsive" id="sra-table">
                      <table class="table table-borderless table-responsive">
                        ...
                        ?>
                          ...
                          <tr>
                            <td width="10%">
                                @if(isset($data_2000_2011->overall_eligibility))
                                    @if($data_2000_2011->overall_eligibility == 1)
                                    Verified
                                    @elseif($data_2000_2011->overall_eligibility == 2)
                                    Not Matched
                                    @elseif($data_2000_2011->overall_eligibility == 3)
                                    Unavailable
                                    @endif
                                @else
                            ...
                            <td width="10%" colspan="6">
                                @if(isset($data_2000_2011->overall_remark))
                                    {{ $data_2000_2011->overall_remark }}
                                @else
                                <textarea class="form-control" style="height:auto!important;"  name="remark" {{ isset($data_2000_2011->overall_remark) ? 'readonly' : '' }} cols="100">{{ isset($data_2000_2011->overall_remark) ? $data_2000_2011->overall_remark : $remark2 }}</textarea>                                @endif
                            </td>
                        </tr>
                ...
                <div class="col-md-3">
                      ...
                      <div class="card">
                          <div class="card-body">
                            ...
                            if(count($query5)==1){
                            ?>
                            <img src="http://sra-uat.apniamc.in/images/{{$hid}}_voter_id3.jpeg" style="height:320px;width:100%;" id="myImg" onerror="this.onerror=null;this.src='http://sra-uat.apniamc.in/images/noimage.jpg';">
                            <?php }else{ ?>
                              <img src="http://sra-uat.apniamc.in/images/noimage.jpg" style="height:320px;width:100%;" >
                            <?php } ?>
                            <!-- start-->
                 ...
                 <div class="card">
                   <div class="card-body">
                     ...
                     ?>
                                  ...
                                  <tr>
                                    <td width="10%">{{isset($namecurrent)?str_replace("Elector s Name","",$namecurrent):'Not Available'}}</td>
                                    <td width="20%">{{isset($addresscurrent)?$addresscurrent:'Not Available'}} </td>
                                    <td width="10%">{{isset($voteridcurrent)?$voteridcurrent:'Not Available'}}</td>
                                    <td width="10%">
                    ...
                    <div class="table-responsive" id="sra-table">
                      <table class="table table-borderless table-responsive">
                        ...
                        ?>
                          ...
                          <tr>
                            <td width="10%">
                              @if(isset($data_current->overall_eligibility))
                                <!-- {{ $data_current->overall_remark }} -->
                                {{ $data_current->overall_eligibility === 1 ? 'Verified' : ($data_current->overall_eligibility === 2 ? ' Not Matched' : ' Unavailable') }}
                            ...
                            <td width="10%" colspan="6">
                              @if(isset($data_current->overall_remark))
                                {{ $data_current->overall_remark }}
                              @else
                              <textarea class="form-control" style="height:auto!important;"  name="remark" {{ isset($data_current->overall_remark) ? 'readonly' : '' }} cols="100">{{ isset($data_current->overall_remark) ? $data_current->overall_remark :  $remark3 }}</textarea>                              @endif
                            </td>
                          </tr>
                    ...
                    <div class="table-responsive" id="sra-table">
                      <table class="table table-borderless table-responsive">
                        ...
                        <tr>
                          ...
                          <tr>
                          <td width="10%">
                            @if(isset($data_current_ca->overall_eligibility))
