...
@if(setting('enable_file_preview'))
    ...
    @elseif($file->extension=='docx') 
		<a  href="javascript:void(0);" data-src="https://docs.google.com/gview?embedded=true&amp;url={{ $file->path }}" data-fancybox="gallery" data-caption="{{ $file->filename }}" data-type="iframe"  ><i class="fas fa-eye"></i></a>
    @elseif($file->isImage()) 
